            ...
            <div class="bg-white rounded-lg shadow-md p-8">
                <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div>
                        ...
                        <input type="text" id="key" name="key" placeholder="напр. tech, furniture, clothing"
                            value="{{ old('key') }}"
                        ...
                        @enderror
                        <p class="mt-1 text-xs text-gray-500">Уникален идентификатор за категорията (малки букви, без
                            интервали)</p>
                    </div>
                    ...
                    <div class="border-t pt-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="name_bg" name="name_bg"
                                placeholder="Въведете категория на български" value="{{ old('name_bg') }}"
