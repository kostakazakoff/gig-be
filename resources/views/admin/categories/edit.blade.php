                ...
                <form action="{{ route('admin.categories.update', $category->id) }}" method="POST"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="description_en" name="description_en" placeholder="Въведете описание на английски" rows="4"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('description_en') border-red-500 @enderror">{{ old('description_en', $category->description) }}</textarea>
