                ...
                <form action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="key" name="key"
                            placeholder="н.p., announcement-2024, press-release" value="{{ old('key') }}"
                        ...
                        @enderror
                        <p class="mt-1 text-xs text-gray-500">Уникален идентификатор за тази статия (малки букви, без
                            прозърци)</p>
                    </div>
                    ...
                    <div class="border-t pt-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="title_en" name="title_en"
                                placeholder="Въведете наслов на новината на английски" value="{{ old('title_en') }}"
                    ...
                    <div class="border-t pt-6">
                        ...
                        <div>
                            ...
                            <textarea id="content_bg" name="content_bg" placeholder="Въведете съдържание на български" rows="6"
                                ...
                                required>{{ old('content_bg') }}</textarea>
                            @error('content_bg')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
