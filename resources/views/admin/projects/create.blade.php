                ...
                <form action="{{ route('admin.projects.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div>
                        ...
                        <input type="text" id="key" name="key"
                            placeholder="н.p., modern-villa, office-renovation" value="{{ old('key') }}"
                        ...
                        @enderror
                        <p class="mt-1 text-xs text-gray-500">Уникален идентификатор на проекта (малки букви, употребявайте
                            тире)</p>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="title_en" name="title_en"
                            placeholder="Въведете наслов на проекта на английски" value="{{ old('title_en') }}"
                    ...
                    <div class="border-t pt-6">
                        ...
                        <div>
                            ...
                            <textarea id="description_bg" name="description_bg" placeholder="Въведете описание на български" rows="4"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('description_bg') border-red-500 @enderror">{{ old('description_bg') }}</textarea>
