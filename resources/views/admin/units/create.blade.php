...
@section('content')
    <div class="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto">
            <!-- Header -->
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-900">Създай нова мерна единица</h1>
                <p class="mt-2 text-gray-600">Добави нова мерна единица в системата</p>
            </div>
