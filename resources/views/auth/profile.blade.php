        ...
        <div class="bg-white shadow rounded-lg p-6 mb-8">
            ...
            <form action="{{ route('auth.update') }}" method="POST">
                ...
                <div class="mt-8 flex items-center justify-end gap-4 pt-6 border-t">
                    ...
                    <button type="submit"
                        class="w-full flex-1 justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        Обнови профил
                    </button>
                </div>
            </form>
